...
```javascript
{ "id": 1, "jsonrpc": "2.0", "method": "vap_getWork" }
```
...
`vap_submitHashrate` is a nonsense method. Pool ignores it and the reply is always:
